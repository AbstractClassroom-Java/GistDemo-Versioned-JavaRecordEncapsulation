...
public record ContactInfo(
    ...
    public String toString(int indentLevel) {
        ...
        if (firstName != null) sb.append(indent).append(firstName);
        ...
        if (phoneNumber != null) sb.append(indent).append("Phone: ").append(phoneNumber).append("\n");
        if (emailAddress != null) sb.append(indent).append("Email: ").append(emailAddress).append("\n");
        ...
        if (birthDate != null) sb.append(indent).append("Birth Date: ").append(birthDate).append("\n");
        return sb.toString();
    }
//
